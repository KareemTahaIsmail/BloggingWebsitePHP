        ...
        <div class="container p-5">
            ...
            <div class="row">
                ...
                <div class="col-md-8 mt-5">
                    ...
                    $_SESSION['cat_id'] = isset($_GET['cat']) ? $_GET['cat'] : 7;
                    
                    if(isset($_SESSION['cat_id'])){
                        $cat_id = $_SESSION['cat_id'];


                        $query = "SELECT * FROM posts WHERE post_category_id LIKE '$cat_id' ";
                        ...
                        if($count == 0){
                            echo "<p class='lead'> NO RESULTS for <span class='font-weight-bold'>this category</span> </p>";
                        } else{
                            ...
                            while($row = mysqli_fetch_assoc($cat_query)) {
                                ...
                                echo "<h2>
                        <a href='".$address."' class='blog-title-link'>{$post_title}</a>
                    </h2>
                    <p><span class='glyphicon glyphicon-time'></span> Posted on {$post_date}</p>
                    <hr>
                    <img class='img-responsive blog-post' src='{$post_image}' alt=''>
                    
                    <a class='btn btn-primary mt-3' style='color:#34ebc0; background-color:black;' href='".$address."'>Read More <span class='glyphicon glyphicon-chevron-right'></span></a>
